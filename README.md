...
### Linear Algebra
- [coderonion/zigen](https://github.com/coderonion/zigen) - Zigen: High-performance linear algebra library for Zig — pure Zig implementation with Eigen-compatible naming, zero dependencies, and zero-allocation APIs for performance-critical code.
...
### GPU Computing
- [coderonion/zcuda](https://github.com/coderonion/zcuda) - zCUDA: Comprehensive, safe, and idiomatic Zig bindings for the entire CUDA ecosystem — from driver API to cuBLAS, cuDNN, cuFFT, cuSOLVER, cuSPARSE, cuRAND, and beyond.
...
- [coderonion/zopencv](https://github.com/coderonion/zopencv) - zOpenCV: High-performance Zig bindings for OpenCV 4.x — bridging the full power of OpenCV and opencv_contrib modules with Zig's zero-cost safety guarantees.
